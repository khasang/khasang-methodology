...
**Мы решили, что изначальное название продукта -- невзрачное и нам не подходит. На каком шаге можно его поменять?**   Для этого хорошо подойдет Step2. Brief. На этом шаге вы как раз более точно определяете, что именно хотите создать. Заодно и время для нейминга. 
