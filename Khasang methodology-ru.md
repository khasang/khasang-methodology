...
При написании брифа необходимо использовать user-stories (Пользовательски истории). 
...
1. Дочерний репозиторий в гитхаб
2. Инициирует waffle.io для работы с issues в виде канбан-доски
3. Группа ВКонтакте
