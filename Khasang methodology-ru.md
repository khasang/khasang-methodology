...
*Обоснование:  
PM не должен за кажым решением бегать советоваться, это очень ответственная роль, он может советоваться, но у него будут широкие полномочия. Но и участники должы быть уверены, что их не попрут от личной неприязни, несправедливо. Каждый может обжаловать исключение.*  
...
13. Уточнена категория проекта (FullTime, F, M, S, Hobby)
...
Необходимо определить целевую аудиторию (ЦА) вашего продукта: возраст, пол, род занятий, уровень дохода, язык, регион проживания.
